...
export default function DashboardPage() {
  const { data: statsData, error: statsError, isLoading: statsLoading } = useSWR<{ success: boolean; stats: Stats }>(
    '/api/admin/stats',
    fetcher,
    {
  ...
  const { data: ordersData, error: ordersError, isLoading: ordersLoading, mutate } = useSWR<{ orders: Order[]; pagination: any }>(
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            <div className="card-modern p-6 border-l-4 border-blue-500 hover:scale-105 transition-transform duration-200 animate-fade-in">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-gray-500 mb-1 uppercase tracking-wide">Pedidos Hoje</p>
                  <p className="text-3xl font-bold text-gray-900 font-display">{stats.today.orders}</p>
                </div>
            ...
            <div className="card-modern p-6 border-l-4 border-primary-500 hover:scale-105 transition-transform duration-200 animate-fade-in">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-gray-500 mb-1 uppercase tracking-wide">Receita Hoje</p>
                  <p className="text-3xl font-bold text-primary-600 font-display">{stats.today.revenueFormatted}</p>
                </div>
            ...
            <div className="card-modern p-6 border-l-4 border-purple-500 hover:scale-105 transition-transform duration-200 animate-fade-in">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-gray-500 mb-1 uppercase tracking-wide">Pedidos Semana</p>
                  <p className="text-3xl font-bold text-gray-900 font-display">{stats.week.orders}</p>
                  <p className="text-sm mt-2 font-medium">{formatChange(stats.week.ordersChange)} vs semana anterior</p>
                </div>
            ...
            <div className="card-modern p-6 border-l-4 border-accent-500 hover:scale-105 transition-transform duration-200 animate-fade-in">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-gray-500 mb-1 uppercase tracking-wide">Receita Semana</p>
                  <p className="text-3xl font-bold text-accent-600 font-display">{stats.week.revenueFormatted}</p>
                  <p className="text-sm mt-2 font-medium">{formatChange(stats.week.revenueChange)} vs semana anterior</p>
                </div>
        ...
        {statsLoading ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
            ...
            <div className="card-modern p-6">
              <h3 className="text-lg font-semibold text-gray-900 mb-4 font-display">Pedidos por Dia da Semana</h3>
              <ResponsiveContainer width="100%" height={300}>
                <BarChart data={stats.dailyStats}>
                  ...
                  <Tooltip />
                  <Legend />
                  <Bar dataKey="orders" fill="#3b82f6" name="Pedidos" radius={[8, 8, 0, 0]} />
                </BarChart>
              </ResponsiveContainer>
            </div>
            ...
            <div className="card-modern p-6">
              <h3 className="text-lg font-semibold text-gray-900 mb-4 font-display">Receita por Dia da Semana</h3>
              <ResponsiveContainer width="100%" height={300}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
          ...
          {stats && (
            <div className="card-modern p-6 border-l-4 border-accent-500 hover:scale-105 transition-transform duration-200">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-lg font-semibold text-gray-900 font-display">Pedidos Pendentes</h3>
              ...
              <div className="text-center">
                <p className="text-5xl font-bold text-accent-600 mb-2 font-display">{stats.pendingOrders}</p>
                <p className="text-sm text-gray-600 font-medium">Aguardando processamento</p>
              </div>
            </div>
          )}
          ...
          {stats?.totalRestaurants !== undefined && (
            <div className="card-modern p-6 border-l-4 border-indigo-500 hover:scale-105 transition-transform duration-200">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-lg font-semibold text-gray-900 font-display">Restaurantes</h3>
              ...
              <div className="text-center">
                <p className="text-5xl font-bold text-indigo-600 mb-2 font-display">{stats.totalRestaurants}</p>
                <p className="text-sm text-gray-600 font-medium">Restaurantes ativos</p>
              </div>
            </div>
          )}
        </div>
