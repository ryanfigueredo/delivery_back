...
export async function PATCH(
  ...
  try {
    ...
    if (!existingOrder) {
      ...
      console.log(`[MARK-PRINTED] Pedido não encontrado - ID: ${orderId} - Tempo de resposta: ${responseTime}ms`)
    ...
    console.error(`[MARK-PRINTED] Erro ao atualizar pedido - ID: ${orderId} - Tempo de resposta: ${responseTime}ms`)
