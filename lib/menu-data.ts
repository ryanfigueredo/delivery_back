...
let MENU_ITEMS: MenuItemData[] = [
  { id: 'hamburguer_bovino_simples', name: 'Hambúrguer Bovino Simples', price: 18, category: 'hamburguer', available: true, order: 1 },
  { id: 'hamburguer_bovino_duplo', name: 'Hambúrguer Bovino Duplo', price: 28, category: 'hamburguer', available: true, order: 2 },
  { id: 'hamburguer_suino_simples', name: 'Hambúrguer Suíno Simples', price: 20, category: 'hamburguer', available: true, order: 3 },
  { id: 'hamburguer_suino_duplo', name: 'Hambúrguer Suíno Duplo', price: 30, category: 'hamburguer', available: true, order: 4 },
  { id: 'refrigerante_coca', name: 'Coca-Cola', price: 5, category: 'bebida', available: true, order: 1 },
  { id: 'refrigerante_pepsi', name: 'Pepsi', price: 5, category: 'bebida', available: true, order: 2 },
  { id: 'refrigerante_guarana', name: 'Guaraná', price: 5, category: 'bebida', available: true, order: 3 },
  { id: 'refrigerante_fanta', name: 'Fanta', price: 5, category: 'bebida', available: true, order: 4 },
  { id: 'suco_laranja', name: 'Suco de Laranja', price: 6, category: 'bebida', available: true, order: 5 },
  { id: 'suco_maracuja', name: 'Suco de Maracujá', price: 6, category: 'bebida', available: true, order: 6 },
 ...
 */
export function updateMenuItem(id: string, updates: Partial<MenuItemData>): MenuItemData | null {
...
export function addMenuItem(item: Omit<MenuItemData, 'order'>): MenuItemData {
  const maxOrder = MENU_ITEMS.filter((i) => i.category === item.category).reduce((m, i) => Math.max(m, i.order), 0)
